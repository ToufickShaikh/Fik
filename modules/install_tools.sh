...
_TOOL_SPECS=(
  ...
  "subjs|subjs|||github.com/lc/subjs@latest"
  "gf|gf|||github.com/tomnomnom/gf@latest"
  "subzy|subzy|PentestPad|subzy|github.com/PentestPad/subzy@latest"
  "puredns|puredns|||github.com/d3mondev/puredns/v2@latest"
  "shuffledns|shuffledns|projectdiscovery|shuffledns|github.com/projectdiscovery/shuffledns/cmd/shuffledns@latest"
  "gowitness|gowitness|sensepost|gowitness|github.com/sensepost/gowitness@latest"
  "trufflehog|trufflehog|trufflesecurity|trufflehog|"
  "gitleaks|gitleaks|gitleaks|gitleaks|"
  "notify|notify|projectdiscovery|notify|github.com/projectdiscovery/notify/cmd/notify@latest"
  "jq|jq|||"
  "unzip|unzip|||"
  "curl|curl|||"
)
